...
public class Trie
{
    ...
    private Trie Initialize(string fileContent, int suggestionNumber)
    {
        Trie trie = new Trie(suggestionNumber);
    ...
    public List<WordData> GetTypeaheadWords(string prefix)
    {
        ...
        wordsWithSamePrefix.RemoveRange(0, this.SuggestionNumber);
